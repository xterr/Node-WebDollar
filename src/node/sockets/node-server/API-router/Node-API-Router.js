...
class NodeAPIRouter{
    ...
    initializeRouter(app, middleWare, prefix='', nodeApiType){
        ...
        addRoute('blockHeight/:blockHeight', NodeAPICustom.blockHeight.bind(NodeAPICustom))
        addRoute('blockHeights/:blockHeights', NodeAPICustom.blockHeights.bind(NodeAPICustom))
        addRoute('blocksStartingWithHeight/:startBlockHeight', NodeAPICustom.blockStartingWithHeight.bind(NodeAPICustom))
    }
